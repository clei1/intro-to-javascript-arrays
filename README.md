...
**TODO**: In `arrays.js`, define a function, `addElementToBeginningOfArray`. It should take two parameters, an array and an element to add to the beginning of the array, and add the element to the beginning of the array and then return the whole array. 

**TODO**: Define another function, `addElementToEndOfArray`. This function should also take two arguments, an array and an element to add to the end of the array. 
